...
```
┌─ mig-gpu-mon ─────────────────────────────────────────────────┐
│ MIG GPU Monitor | Driver: 535.129.03 | CUDA: 12.2 | GPUs: 3  │
├─ CPU (64 cores) 23.4% ─────┬─ Devices ───────────────────────┤
│  0 ▮▮▯▯▯▯▯  12%  32 ▮▯▯▯  3%│ > MIG 0 (GPU 0: A100) GPU:45% │
│  1 ▮▮▮▯▯▯▯  34%  33 ▮▮▯▯ 18%│   MIG 1 (GPU 0: A100) GPU:12% │
│  ...                       │   GPU 0: A100-SXM4-80GB         │
├─ Memory ───────────────────┼─ Detail ─────────────────────────┤
│ RAM ▮▮▮▮▮▯▯ 89.2/256 GiB  │ VRAM: 12288 / 20480 MB (60.0%) │
│ SWP ▮▯▯▯▯▯▯  2.1/32 GiB   │ GPU Util: 45%  SM Util: 45%    │
├─ GPU Utilization % ────────┼─ CPU Total 23.4% ───────────────┤
│ ▁▂▃▅▇█▇▅▃▂▁▂▃▅▇█          │ ▂▂▃▃▂▂▃▂▃▃▂▂▃▃                 │
├─ Memory Utilization % ─────┼─ RAM 89.2/256 GiB (34.8%) ──────┤
│ ▃▃▃▄▄▅▅▅▄▃▃▃▄▄▅           │ ▅▅▅▅▅▅▅▅▅▅▅▅▅▅                 │
├─ GPU % ──────┬─ VRAM ──────┼─ RAM ───────────────────────────┤
│ ████░░ 45%   │ ██████ 60%  │ █████████░░░ 89.2/256 GiB      │
├───────────────────────────────────────────────────────────────┤
│ q Quit  Tab/↑↓ Switch GPU  [1/3]                             │
└───────────────────────────────────────────────────────────────┘
```
